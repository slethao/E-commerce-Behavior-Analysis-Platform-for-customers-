...
def main():
    ...
    #     all_groups = data.readline().split(",")
    #     content = data.readlines()
    #     automate_workflow = automated_dag.Prefect_DAG(content, file_path, all_groups)
    #     automate_workflow.create_the_dag()

    #     content = automate_workflow.pull_from_db(table_name)
    #     print(f"Records for table: {len(content)} records.")
        ...
        # #NOTE this the end of the first ot go
        ...
        #     #NOTE this will be the end of what will stay

        #     #NOTE this will the get rid of
        ...
        #     #NOTE this wil be the end of the get rid of

        #     #NOTE this will be get rid of
        ...
        #         #print(f"These are the tables in postgres(proccessed_data): {query_obj.view_table_content("processed_data")}") # work
        #         print(f"The number of records(proccessed_data): {len(query_obj.view_table_content("processed_data"))}")
        #     #NOTE this will be the end of the get rid of
